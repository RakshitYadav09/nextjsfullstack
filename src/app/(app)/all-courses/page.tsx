  ...
  return (
    <ToastProvider>
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-center mb-8">All Courses ({courses.length})</h1>
      ...
      {toastMessage && (
        <Toast open={!!toastMessage} onOpenChange={() => setToastMessage(null)} className="max-w-sm mx-auto mt-4">
